...
public class ModelGenerator {
    protected static final Logger log = LoggerFactory.getLogger(ModelGenerator.class);
    ...
    static MultiLayerNetwork getModelForType(String modelType,Integer numLabels) {
        switch (modelType) {
            case "LeNet":
                return ModelGenerator.lenetModel(numLabels);
            case "AlexNet":
                return  ModelGenerator.alexnetModel(numLabels);
//            case "custom":
//                network = ModelGenerator.customModel();
//                break;
            default:
